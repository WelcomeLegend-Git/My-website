...
const GoogleSignUpButton = ({
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 text-center leading-none">Continue with Google</span>
    </button>
  );
};
      ...
      <div className="relative w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8 scale-in">
        ...
        <header className="space-y-3 sm:space-y-4 text-center fade-in-down">
          ...
          <p className="text-xs sm:text-sm text-slate-400 max-w-xs sm:max-w-sm mx-auto px-2">
            Start centralising formulas, mistakes, and AI support in one powerful platform.
          </p>
        </header>
        ...
        <div className="relative group">
          ...
          <div className="relative space-y-4 sm:space-y-5 rounded-3xl glass-card border border-slate-800/50 p-5 sm:p-8 fade-in-up">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <span className="text-xs text-slate-500 font-medium uppercase tracking-wider whitespace-nowrap">or sign up with email</span>
              <div className="flex-1 border-t border-slate-700/60" />
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
              ...
              {activeError && (
                <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-3 sm:p-4 flex items-start gap-3 fade-in">
                  ...
                  <p className="text-xs sm:text-sm text-red-300">{activeError.message ?? "Unable to create account"}</p>
                </div>
              )}
              ...
              <button
                type="button"
                onClick={() => { authStorage.setGuestMode(); navigate("/", { replace: true }); }}
