    ...
    <div className="min-w-0 h-full">
      <div className="relative flex h-full w-full text-slate-100 rounded-3xl border border-slate-800/60 bg-slate-950/80 overflow-hidden">
        ...
        <div className="h-14 border-b border-slate-800 flex items-center px-4 bg-slate-900">
          ...
          <div className="flex items-center gap-3" style={{marginLeft: sidebarOpen ? '0.75rem' : '0'}}>
                  ...
                  >
                    {mutation.isPending || quizMutation.isPending ? (
                      ...
                      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l18-9-9 18-2-7-7-2z" />
                      </svg>
                    )}
                  </button>
                </div>
