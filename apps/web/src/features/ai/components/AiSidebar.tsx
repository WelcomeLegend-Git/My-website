...
export const AiSidebar = ({ open, section, context }: Props) => {
  ...
  return (
    <>
      ...
      <aside className="hidden w-96 xl:w-[420px] flex-shrink-0 flex-col border-l border-slate-800/50 glass-card p-5 xl:flex fade-in-right sticky top-0 h-screen self-start">
