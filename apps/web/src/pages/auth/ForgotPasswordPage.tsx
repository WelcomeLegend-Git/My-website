...
export const ForgotPasswordPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-paper px-6 py-12 text-ink overflow-hidden">
        ...
        <header className="space-y-4 text-center fade-in-down">
          <div className="inline-flex items-center justify-center">
            <div className="relative group">
              <div className="relative px-6 py-3 glass-card rounded-2xl border border-brass/30">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold font-display text-ink">
        ...
        <div className="relative group">
          {step === "request" ? (
            <form
              ...
              className="relative space-y-5 rounded-3xl glass-card border border-line p-8 fade-in-up"
            >
              ...
              <button
                ...
                className="w-full rounded-xl bg-brass hover:bg-brass-strong px-5 py-3.5 text-sm font-bold text-white disabled:cursor-not-allowed disabled:opacity-70 transition-all duration-300 hover-lift disabled:hover:transform-none flex items-center justify-center gap-2"
              >
                {isRequesting ? (
                  <>
                    <svg
            ...
            >
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-line bg-surface-2 px-4 py-3 text-sm text-ink placeholder-ink-muted focus:border-brass/50 focus:outline-none focus:ring-2 focus:ring-brass/20 transition-all tracking-[0.3em] text-center"
