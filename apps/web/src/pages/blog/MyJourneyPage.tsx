            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <motion.header variants={item} className="space-y-6 text-center">
                        ...
                        <h1 className="text-4xl md:text-[3rem] lg:text-[3.75rem] font-bold tracking-tight leading-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-200 to-cyan-400">
