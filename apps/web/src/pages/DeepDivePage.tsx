  ...
  return (
    <section className="space-y-8">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="glass-card rounded-2xl border border-primary/30 px-4 py-3 sm:px-5 sm:py-4 flex flex-col gap-2 max-w-sm hover-lift">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs sm:text-sm text-slate-300">
              <div>
                <p className="text-slate-400 mb-0.5">Stack</p>
              ...
              <div>
                <p className="text-slate-400 mb-0.5">Infra</p>
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.3fr)] items-start">
        {/* TOC / Side panel */}
        <aside className="glass-card rounded-2xl border border-slate-800/60 p-4 sm:p-5 space-y-4 hover-lift">
          <div>
          ...
          <div className="space-y-2 text-sm">
            <p className="text-xs uppercase tracking-[0.18em] text-slate-500 font-semibold">Sections</p>
            <a href="#context" className="block px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-900/70 hover:text-primary transition-colors">
              1. Context &amp; Constraints
            </a>
            <a href="#architecture" className="block px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-900/70 hover:text-primary transition-colors">
              2. Architecture &amp; Monorepo
            </a>
            <a href="#frontend" className="block px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-900/70 hover:text-primary transition-colors">
              3. Frontend &amp; UX Decisions
            </a>
            <a href="#backend" className="block px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-900/70 hover:text-primary transition-colors">
              4. Backend, Data &amp; AI System
            </a>
            <a href="#hosting" className="block px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-900/70 hover:text-primary transition-colors">
              5. Hosting, Free Tiers &amp; Deployments
            </a>
            <a href="#ai-helpers" className="block px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-900/70 hover:text-primary transition-colors">
        ...
        {/* Main content */}
        <article className="glass-card rounded-2xl border border-slate-800/60 p-4 sm:p-6 lg:p-7 space-y-8 custom-scrollbar max-h-[min(1100px,80vh)] overflow-y-auto hover-lift">
          {/* 1. Context */}
          <section id="context" className="space-y-3">
            <h2 className="text-lg sm:text-xl font-semibold text-slate-100 flex items-center gap-2">
              <span className="w-7 h-7 rounded-lg bg-primary/10 flex items-center justify-center text-xs text-primary font-bold">
                1
              </span>
              Context &amp; Constraints
            </h2>
          ...
          <section id="architecture" className="space-y-3">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-slate-200 space-y-1.5">
              <li>
                <span className="font-semibold text-slate-100">apps/web</span> – React + Vite + TypeScript frontend
              </li>
              <li>
                <span className="font-semibold text-slate-100">apps/server</span> – Node/Express backend with tRPC and Prisma
              </li>
              <li>
                <span className="font-semibold text-slate-100">shared/packages</span> (conceptually) – types and utilities shared between
                client and server
              </li>
            </ul>
            <p className="text-sm sm:text-base text-slate-200 leading-relaxed">
          ...
          <section id="frontend" className="space-y-3">
            ...
            <p className="text-sm sm:text-base text-slate-200 leading-relaxed">
              ...
              custom utility classes like <span className="font-mono text-xs bg-slate-900/70 px-1.5 py-0.5 rounded">glass-card</span>,
              <span className="font-mono text-xs bg-slate-900/70 px-1.5 py-0.5 rounded ml-1">hover-lift</span>, and animated gradients
          ...
          <section id="hosting" className="space-y-3">
            ...
            <p className="text-sm sm:text-base text-slate-200 leading-relaxed">
              ...
              a deep link like <span className="font-mono text-xs bg-slate-900/70 px-1.5 py-0.5 rounded">/auth/login</span> directly
