    ...
    <>
      ...
      <div className="relative mb-5 flex-shrink-0">
        ...
        <div className="relative glass-card rounded-2xl p-4 border border-emerald-500/20">
          ...
          <button
            type="button"
            className="absolute left-2 top-1/2 -translate-y-1/2 h-9 w-9 flex items-center justify-center rounded-lg hover:bg-slate-800/60 border border-slate-800/60 transition-colors"
