...
const GoogleSignUpButton = ({
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 rounded-xl border border-line bg-surface-2 px-5 py-3.5 text-sm font-semibold text-ink hover:bg-surface-2 hover:border-line disabled:cursor-not-allowed disabled:opacity-60 transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] shadow-sm"
    >
      {googleLoading ? (
        <svg
          className="w-5 h-5 animate-spin text-ink-muted"
          fill="none"
          viewBox="0 0 24 24"
        >
          <circle
...
export const RegisterPage = () => {
  ...
  }, [googleMutation.isSuccess, googleMutation.data, handleAuth, navigate]);
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-paper px-4 py-8 sm:px-6 sm:py-12 text-ink overflow-hidden">
      <div className="relative w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8 scale-in">
        ...
        <header className="space-y-3 sm:space-y-4 text-center fade-in-down">
          <div className="inline-flex items-center justify-center">
            <div className="relative group">
              <div className="relative px-5 py-2.5 sm:px-6 sm:py-3 glass-card rounded-2xl border border-brass/30">
                <p className="text-xs uppercase tracking-[0.3em] text-brass font-mono font-bold">
                  JEE Companion
                </p>
              </div>
            </div>
          </div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-display text-ink">
            Create your account
          </h1>
          <p className="text-xs sm:text-sm text-ink-muted max-w-xs sm:max-w-sm mx-auto px-2">
            Start centralising formulas, mistakes, and AI support in one
            powerful platform.
          </p>
        </header>
        ...
        {/* Form Card */}
        <div className="relative group">
          <div className="relative space-y-4 sm:space-y-5 rounded-3xl glass-card border border-line p-5 sm:p-8 fade-in-up">
            {/* Google Button */}
            <GoogleSignUpButton
              loading={isLoading}
            ...
            <div className="relative flex items-center gap-3">
              ...
              <span className="text-xs text-ink-muted font-medium uppercase tracking-wider whitespace-nowrap">
            ...
            >
              ...
              {activeError && (
                <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-3 sm:p-4 flex items-start gap-3 fade-in">
                  ...
                  <p className="text-xs sm:text-sm text-red-500">
                    {activeError.message ?? "Unable to create account"}
                  </p>
                </div>
              )}
              ...
              <button
                ...
                className="w-full rounded-xl border border-line bg-surface-2 px-5 py-3 sm:py-3.5 text-sm font-semibold text-ink hover:bg-surface-2 hover:border-line transition-all duration-300 flex items-center justify-center gap-2"
              >
                <svg
        ...
        <div className="text-center fade-in">
          <p className="text-sm text-ink-muted">
            ...
            <Link
              to="/auth/login"
              className="text-brass hover:text-brass-strong font-semibold transition-colors"
            >
              Sign in
            </Link>
          </p>
